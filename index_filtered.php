        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1><i class="bi bi-currency-dollar"></i> ADESCO - Sistema de Contabilidad</h1>
                    <p class="lead">Gestión de entradas, salidas y saldo</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="filter-section">
            <div class="row align-items-center">
                <div class="col-md-8">
                    <h5><i class="bi bi-funnel"></i> Filtrar por Mes/Año</h5>
            ...
            <div class="col-md-4">
                <div class="card balance-card text-center">
                    <div class="card-body">
                        ...
                        <h2 class="display-4"><?php echo number_format($saldo, 2); ?> $</h2>
                        <?php if (($month > 0 && $year > 0)): ?>
                            <small class="text-light">Saldo general: <?php echo number_format($saldo_all, 2); ?> $</small>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h2 class="display-5 entrada">+<?php echo number_format($total_entradas, 2); ?> $</h2>
                        <?php if (($month > 0 && $year > 0)): ?>
                            <small class="text-muted">Total general: +<?php echo number_format($total_entradas_all, 2); ?> $</small>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h2 class="display-5 salida">-<?php echo number_format($total_salidas, 2); ?> $</h2>
                        <?php if (($month > 0 && $year > 0)): ?>
                            <small class="text-muted">Total general: -<?php echo number_format($total_salidas_all, 2); ?> $</small>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="">
                            ...
                            <div class="mt-3">
                                <?php if ($edit_entry): ?>
                                    <button type="submit" name="update_entry" class="btn btn-warning">
                                        <i class="bi bi-save"></i> Actualizar Entrada
                                    </button>
                                    <a href="index.php<?php echo ($month > 0 || $year > 0) ? '?month=' . $month . '&year=' . $year : ''; ?>" class="btn btn-secondary">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                        <h3 class="mb-0"><i class="bi bi-table"></i> Registro de Entradas y Salidas</h3>
